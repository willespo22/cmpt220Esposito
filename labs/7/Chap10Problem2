...
public class Chap10Problem2 {
  ...
  public Chap10Problem2(String name, int age, double weight, double height) {
    this.name = name;
    this.age = age;
    this.height = height;
    this.weight = weight;
  ...
  public Chap10Problem2(String name, double weight, double height) {
  ...
  * feet, and inches
  */
  public Chap10Problem2(String name, int age, double weight, double feet,
    double inches) {
